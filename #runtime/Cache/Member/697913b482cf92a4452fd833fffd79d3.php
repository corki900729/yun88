...
<head>
    <meta charset="UTF-8">
    <title>注册</title>
    <link rel="stylesheet" href="<?php echo ($config_siteurl); ?>statics/extres/newmember/css/normalize.css">
    <link rel="stylesheet" href="<?php echo ($config_siteurl); ?>statics/extres/newmember/css/common.css">
    <link rel="stylesheet" type="text/css" href="<?php echo ($config_siteurl); ?>statics/extres/newmember/css/log.css">
    <script src="<?php echo ($config_siteurl); ?>statics/extres/newmember/js/respond.min.js"></script>

    <script src="<?php echo ($config_siteurl); ?>statics/extres/newmember/js/jquery.js"></script>
    <script src="<?php echo ($config_siteurl); ?>statics/extres/newmember/js/logPage/logPage.js"></script>
</head>

<body>
    <div class="log-head">
        <div class="container">
            <div class="logo"><a href="/"><img src="<?php echo ($config_siteurl); ?>statics/extres/newmember/images/yun88.png" alt="yun88" /></a></div>
    ...
    <div class="reg-sheet">
        <div class="container pt-5">
            ...
            <div class="sheet">
                ...
                <form action="<?php echo U('Public/doRegister');?>" method="post">
                    <div>
                        <label>用户名 ：
                        </label>
                    ...
                    <div>
                        ...
                        <img class="yanzheng_img" id="code_img" alt="" src="<?php echo U('Api/Checkcode/index','code_len=4&font_size=20&width=130&height=50&font_color=&background=');?>"><a href="javascript:;;" onClick="refreshs()" class="change_img">看不清，换一张</a>
                    </div>                    
                    <div>
                        <label>手机验证码 ：
                        </label>
...
<script src="<?php echo ($config_siteurl); ?>statics/extres/newmember/layer/layer.js"></script>
<script>
// 验证码刷新
function refreshs(){
...
function sendMessage() {
  ...
  　curCount = count;
    ...
    $.ajax({
        ...
        url: "<?php echo U('Member/Public/dosmsCode');?>", //目标地址
