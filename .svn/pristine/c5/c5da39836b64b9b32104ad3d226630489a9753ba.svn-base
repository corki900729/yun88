...
<body>
  <link href="{$config_siteurl}statics/market/dist/solution/solution-video.css" rel="stylesheet">
  <script src="{$config_siteurl}statics/market/dist/solution/solution-video.js"></script>
...
<template file="Content/header.php"/>
    ...
    <div class="banner">
      <div class="container">
        <img alt="" src="{$config_siteurl}statics/market/images/solution-video/banner.jpg" />
      </div>
    </div>
          ...
          <div class="row">
            <div class="l-col-3">
              <div class="img-holder">
                <img src="{$config_siteurl}statics/market/images/solution-video/icon_03.jpg" />
              </div>
            ...
            <div class="l-col-3">
              <div class="img-holder">
                <img src="{$config_siteurl}statics/market/images/solution-video/icon_05.jpg" />
              </div>
              <div class="text-holder">
                <h4>直播</h4>
            ...
            <div class="l-col-3">
              <div class="img-holder">
                <img src="{$config_siteurl}statics/market/images/solution-video/icon_07.jpg" />
              </div>
              <div class="text-holder">
                <h4>互动直播</h4>
            ...
            <div class="l-col-3">
              <div class="img-holder">
                <img src="{$config_siteurl}statics/market/images/solution-video/icon_09.jpg" />
              </div>
              <div class="text-holder">
                <h4>云通信</h4>
      ...
      <div class="container">
        <div class="lay02-inner">
          <div class="lay02-left">
            ...
            <div class="lay02-left-img"><img src="{$config_siteurl}statics/market/images/solution-video/bg1.png" /></div>
          </div>
      ...
      <div class="container">
        ...
        <div class="lay03-inner">
          <div class="row row1">
            <div class="l-col-4">
              <div class="lay03-left">
                <img src="{$config_siteurl}statics/market/images/solution-video/bg6.png" />
              </div>
            </div>
            <div class="l-col-8">
              <div class="lay03-right">
                ...
                <p class="tw1"><img src="{$config_siteurl}statics/market/images/solution-video/zt1.png"/></p>
              </div>
            </div>
          </div>
          ...
          <div class="row row2">
            <div class="l-col-8">
              <div class="lay03-right">
                ...
                <p class="tw1"><img src="{$config_siteurl}statics/market/images/solution-video/zt2.png"/></p>
              </div>
            </div>
            <div class="l-col-4">
              <div class="lay03-left">
                <img src="{$config_siteurl}statics/market/images/solution-video/bg7.png" />
              </div>
            </div>
          </div>
          ...
          <div class="row row1">
            <div class="l-col-4">
              <div class="lay03-left">
                <img src="{$config_siteurl}statics/market/images/solution-video/bg8.png" />
              </div>
            </div>
            <div class="l-col-8">
              <div class="lay03-right">
                ...
                <p class="tw1"><img src="{$config_siteurl}statics/market/images/solution-video/zt3.png"/></p>
              </div>
            </div>
          </div>
          ...
          <div class="row row2">
            <div class="l-col-8">
              <div class="lay03-right">
                ...
                <p class="tw1"><img src="{$config_siteurl}statics/market/images/solution-video/zt4.png"/></p>
              </div>
            </div>
            <div class="l-col-4">
              <div class="lay03-left">
                <img src="{$config_siteurl}statics/market/images/solution-video/bg9.png" />
              </div>
            </div>
          </div>
