...
return array(
    ...
    'TMPL_ACTION_ERROR' =>  PROJECT_PATH.'Template/Default/error.php', // 默认错误跳转对应的模板文件
    'TMPL_ACTION_SUCCESS' => PROJECT_PATH.'Template/Default/success.php', // 默认成功跳转对应的模板文件
    ...
    /*支付宝配置*/
    'ALIPAY' => array(
        'alipay_pay_method' => 2,  //支付宝交易类型 1担保支付 2即时到账
        'partner' => '2088701490843053', //合作身份者id
        'seller_email' => 'zhaixin@yuandingsoft.com', //收款支付宝账号
        'key' => 'hnd7fmxv7uazq4stugz9g5l5ccaqo66f', //安全检验码
        'notify_url' => 'http://www.yun88.com/index.php/Yun/Payment/notifyUrl', //服务器异步通知页面路径
        'return_url' => 'http://www.yun88.com/index.php?g=Yun&m=Payment&a=returnUrl',//页面跳转同步通知页面路径
    ),
);
