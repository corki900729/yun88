...
class alipay {          
    ...
    public function  __construct($config_value) {   
        ...
        $this->alipay_config['partner']       = $config_value['partner'];//合作身份者id，以2088开头的16位纯数字
        $this->alipay_config['seller_email']  = $config_value['seller_email'];//收款支付宝账号，一般情况下收款账号就是签约账号
        $this->alipay_config['key']	      = $config_value['key'];//安全检验码，以数字和字母组成的32位字符
        $this->alipay_config['notify_url']	      = $config_value['notify_url'];//安全检验码，以数字和字母组成的32位字符
        $this->alipay_config['return_url']	      = $config_value['return_url'];//安全检验码，以数字和字母组成的32位字符
     ...
     */
    function get_code($order, $config_value=array()){         
             // 接口类型
            $service = array(             
            ...
            $parameter = array(
                        ...
                        "subject"	=> 'Yun88', //订单名称 可以中文
                        "total_fee"	=> $order['total_fee'], //付款金额 $order['total_fee']
