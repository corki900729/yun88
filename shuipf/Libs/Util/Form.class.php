...
class Form {
     ...
     * @param array $file_setting
     */
    public static function video($name, $id = '', $value = '', $moudle = '', $catid = '', $size = 50, $class = '', $ext = '', $alowexts = '', $file_setting = array()) {
        if (!$id)
            $id = $name;
        if (!$size)
            $size = 50;
     ...
     * @param array $file_setting
     */
    public static function uploadvideo($name, $id = '', $value = '', $moudle = '', $catid = '', $size = 50, $class = '', $ext = '', $alowexts = '', $file_setting = array()) {
        if (!$id)
            $id = $name;
        if (!$size)
            $size = 50;
        ...
        if (!empty($file_setting) && count($file_setting))
            ...
            $file_ext = ',';
        if (!$alowexts)
            $alowexts = 'zip|rar|mp4|doc|pdf|docx|ppt|xls';
        if (!defined('UPFILES_INIT')) {
            $str = '<script type="text/javascript" src="' . CONFIG_SITEURL_MODEL . 'statics/js/content_addtop.js"></script>';
            define('UPFILES_INIT', 1);
        }
