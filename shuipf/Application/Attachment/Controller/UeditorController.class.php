...
class UeditorController extends AttachmentsController {
    ...
    protected function _initialize() {
        ...
        if ($this->isadmin) {
            //上传大小
            $this->confing['imageMaxSize'] = $this->confing['scrawlMaxSize'] = $this->confing['catcherMaxSize'] = $this->confing['videoMaxSize'] = $this->confing['fileMaxSize'] = self::$Cache['Config']['uploadmaxsize'] * 1024*1024;
            //上传文件类型
