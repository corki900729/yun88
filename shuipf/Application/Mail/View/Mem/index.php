...
<div class="wrap J_check_wrap">
  ...
  <form name="searchform" action="" method="get" >
    ...
    <input type="hidden" value="Mem" name="m">
        ...
        <tbody>
          <volist name="data" id="vo">
            <tr>
              ...
              <td align="left"><a href="{:U('Mem/edit', array('id'=>$vo['id']) )}">修改 | <a href="{:U('Mem/delete',array('id'=>$vo['id']))}" class="J_ajax_del">删除</a></a></td>
            </tr>
          </volist>
        </tbody>
      </table>
