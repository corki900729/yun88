...
<div class="wrap J_check_wrap">
  ...
  <form name="searchform" action="" method="get" >
    ...
    <input type="hidden" value="Source" name="m">
        ...
        <tbody>
          <volist name="data" id="vo">
            <tr>
              ...
              <td align="left"><a href="{:U('Goods/problem', array('id'=>$vo['gp_id']))}">{$vo.source_name}</a></td>
              <td align="left">{$vo.create_time|date='Y-m-d H:i:s',###}</td>
              <td align="left"><a href="{:U('Source/edit',array('id'=>$vo['id']))}" class="J_ajax_edit">修改</a> | <a href="{:U('Source/delete',array('id'=>$vo['id']))}" class="J_ajax_del">删除</a></td>
            </tr>
          </volist>
        </tbody>
      </table>
