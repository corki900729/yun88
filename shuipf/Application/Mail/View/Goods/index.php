        ...
        <tbody>
          <volist name="data" id="vo">
            <tr>
              ...
              <td align="left"><a href="{:U('Goods/problem', array('id'=>$vo['gp_id']))}"><img src="{$vo.img_logo}" height=50 width=50></a></td>
              ...
              <td align="left"><a href="{:U('Goods/edit', array('id'=>$vo['gp_id']) )}">修改 | <a href="{:U('Goods/delete',array('id'=>$vo['gp_id']))}" class="J_ajax_del">删除</a></a></td>
            </tr>
          </volist>
        </tbody>
      </table>
